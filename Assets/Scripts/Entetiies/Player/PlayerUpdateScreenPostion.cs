...
public class PlayerUpdateScreenPostion : MonoBehaviour
{
    void LateUpdate()
    {
        ...
        Shader.SetGlobalVector("_PlayerScreenPosition", Camera.main.WorldToScreenPoint(transform.position) / new Vector2(Camera.main.pixelWidth, Camera.main.pixelHeight));
    }
}
